...
\title{Construction of an FPGA time tagger}
\author{Ben Gamari}
...
The time-tagger is built around an the Xylo EM development board. This
...
First, we install the FX2 firmware package,
...
This configures your computer such that the firmware is automatically
uploaded to the device when plugged in.
